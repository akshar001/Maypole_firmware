...
void ESP32WebServer::on(const String &uri, WebRequestMethod method, ESP32WebServer::THandlerFunction fn) {
  on(uri, method, fn, _fileUploadHandler);
}

void ESP32WebServer::on(const String &uri, WebRequestMethod method, ESP32WebServer::THandlerFunction fn, ESP32WebServer::THandlerFunction ufn) {
