...
public:
    FunctionRequestHandler(ESP32WebServer::THandlerFunction fn, ESP32WebServer::THandlerFunction ufn, const String &uri, WebRequestMethod method)
    : _fn(fn)
    , _ufn(ufn)
    , _uri(uri)
    , _method(method)
    ...
    bool canHandle(WebRequestMethod requestMethod, String requestUri) override  {
    ...
    bool handle(ESP32WebServer& server, WebRequestMethod requestMethod, String requestUri) override {
        (void) server;
